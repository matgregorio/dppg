<?php
	...
	if (protectorString($_POST[codigo_link]) === true || protectorString($_POST[nome_link]) === true || protectorString($_POST[endereco_link]) === true || protectorString($_POST[tipo_link]) === true)
		return;
