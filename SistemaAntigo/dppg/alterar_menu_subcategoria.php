<?php
	...
	if (protectorString($_POST[codigo_subcategoria]) || protectorString($POST[combo_categoria]) || protectorString($POST[nome_subcategoria]) || protectorString($POST[conteudo_subcategoria]))
		return;
