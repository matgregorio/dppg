...
//          $resumo = str_replace("</p>", "", $resumo);
            ...
            <div class="tgl">
              ...
              <?php echo "<a href='../simposio2014/../simposio2014/gerar_pdf_trabalhos.php?codigot=$campos[codigo_trab]' target='_blanck' align='rigth'><img src='images/pdf.png'> Gerar PDF</a>"; ?>
            </div>
            <hr>
            <?php
          }
