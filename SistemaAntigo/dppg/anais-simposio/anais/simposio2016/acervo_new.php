  ...
  <div id="post-5" class="post-5 page type-page status-publish hentry">
    ...
    <div class="entry clearfix">
      ...
      <div id="box-toggle">
        ...
        //Comeca a montar o toggle do resumo
        if (mysql_num_rows($query_trab) > 0) 
        {
          ...
          while ($campos = mysql_fetch_array($query_trab)) {
            ...
            $titulo = mb_strtoupper($campos[titulo], 'UTF-8');
            
            //Titulo e codigo do trabalho
...
//          $resumo = str_replace("</p>", "", $resumo);
            ?>
           <!--Div (efeito) que armazena o resumo-->
            <div class="tgl">
              <br>
              ...
              <?php echo "<a href='../simposio2016/../simposio2016/gerar_pdf_trabalhos.php?codigot=$campos[codigo_trab]' target='_blanck' align='rigth'><img src='images/pdf.png'> Gerar PDF</a>"; ?>
            </div>
            <hr>
            <?php
          }
