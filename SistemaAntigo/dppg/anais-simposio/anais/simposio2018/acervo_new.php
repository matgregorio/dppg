...
//          $resumo = str_replace("</p>", "", $resumo);
            ...
            <div class="tgl">
              ...
              <?php echo "<a href='../simposio2018/../simposio2018/gerar_pdf_trabalhos.php?codigot=$campos[codigo_trab]' target='_blanck' align='rigth'><img src='images/pdf.png'> Gerar PDF</a>"; ?>
            </div>
            <hr>
            <?php
          }
