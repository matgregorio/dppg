...
<?php
include('/var/www/html/simposio2020/includes/config.php');
...
//          $resumo = str_replace("</p>", "", $resumo);
            ...
            <div class="tgl">
              ...
              <?php echo "<a href='../simposio2020/../simposio2020/gerar_pdf_trabalhos.php?codigot=$campos[codigo_trab]' target='_blanck' align='rigth'><img src='images/pdf.png'> Gerar PDF</a>"; ?>
            </div>
            <hr>
            <?php
          }
