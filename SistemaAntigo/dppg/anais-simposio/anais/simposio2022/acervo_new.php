...
<?php
include('/var/www/html/simposio2022/includes/config.php');
      ...
      <div id="box-toggle">
        ...
        if (mysql_num_rows($query_trab) > 0)
        {
          ...
          while ($campos = mysql_fetch_array($query_trab))
          {
            ...
            $orientador = '';
            $apoios = '';
            //$titulo = strtr(strtoupper($campos[titulo]), "àáâãäåæçèéêëìíîïðñòóôõö÷øùüúþÿ", "À�?ÂÃÄÅÆÇÈÉÊËÌ�?Î�?�?ÑÒÓÔÕÖ×ØÙÜÚÞß");
...
//          $resumo = str_replace("</p>", "", $resumo);
            ...
            <div class="tgl">
              ...
              <?php echo "<a href='../simposio2022/../simposio2022/gerar_pdf_trabalhos.php?codigot=$campos[codigo_trab]' target='_blanck' align='rigth'><img src='images/pdf.png'> Gerar PDF</a>"; ?>
            </div>
            <hr>
            <?php
          }
