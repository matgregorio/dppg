<?php
	...
	if (protectorString($_POST[combo_posicao]) || protectorString($_POST[combo_categoria]) || protectorString($_POST[nome_subcategoria]) ||
		protectorString($_POST[conteudo_subcategoria]))
		return;
