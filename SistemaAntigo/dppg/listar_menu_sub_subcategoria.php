<?php
	...
	if ($_SESSION[logado_site_dppg])
	{
		...
		if($pesquisa_admgeral) 
		{
			...
			echo '<center><h2>Editar Sub-Subcategoria do Menu</h2></center>';
			echo '<hr>';
			...
			while ($campos = mysql_fetch_array($resultado)) 
			{
				...
				while ($campos1 = mysql_fetch_array($resultado1)) 
				{
					...
					while($campos2 = mysql_fetch_array($resultado2)) {
						echo "
						<a href='index.php?arquivo=form_editmenu_sub_subcategoria.php&codigo_sub_subcategoria=$campos2[codigo_sub_subcategoria]'><img src=images/editar.png width=16 height=16 border=0 alt=editar>$campos2[nome_sub_subcategoria]</a><br>
						";
					}
				}
				echo '<br></center>';
