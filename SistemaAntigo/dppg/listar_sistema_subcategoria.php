<?php
	...
	if ($_SESSION[logado_site_dppg])
	{
		...
		if($pesquisa_admgeral) 
		{
			...
			echo '<center><h2>Alterar Subcategoria do Menu Sistema</h2></center>';
			...
			while ($campos = mysql_fetch_array($resultado)) 
			{
				...
				{
					echo "
					<a href='index.php?arquivo=form_editsistema_subcategoria.php&codigo_subcategoria=$campos1[codigo_subcategoria]'><img src=images/editar.png width=16 height=16 border=0 alt=editar>$campos1[nome_subcategoria]</a><br>";
				}
				echo '<br></center>';
			}
		}	
