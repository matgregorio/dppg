...
if (in_array(1, $_SESSION[codigo_grupo]))
{
    ...
    if (move_uploaded_file($_FILES['arquivo']['tmp_name'], $caminhoArquivoServidor))
    {
        ...
        {
            if($nomeExibicao == "")
                $nomeExibicao = "REGULAMENTO_SIMPOSIO.pdf";

            $queryNomeExibicao = "UPDATE arquivo SET nome_arquivo = '$nomeExibicao' WHERE codigo_arquivo = '8'";
            $updateNomeExibicao = mysql_query($queryNomeExibicao) or die("Erro ao alterar nome de exibição do arquivo");

            $query = "update arquivo set caminho_arquivo='$nomeExibicao' where codigo_arquivo='8'";

            if(mysql_query($query))
            {
                echo "<br><br><br><br><br><br><br>";
                echo "<center><font color='#006400'><b>Regulamento alterado com sucesso!!!</b></font></center>";
