...
if ($_SESSION[logado_simposio_2021])
{
    ...
    else
    {
        ...
        /*Só abre o certificado os participantes do trabalho, o os administradores do sistema*/
        ...
        if(!$poster)
        {
            ...
            Inova&ccedil;&atilde;o e Tecnologia do Campus Rio Pomba, realizado entre os dias 25 e 26 de outubro de 2023.";
            ...
            $html = <<<TAG
                    ...
                    <body>
                        ...
                        <div id = 'container' style='position: absolute; left: 0; right: 0; top: 0; bottom: 0; z-index: 0;'>
                            ...
                            <!--Palavra 'Certificado'-->
                            <div style='position: fixed; width: 250px;  margin-top: -540px; z-index: 0; margin-left:43%; background-color:orange;'>
...
TAG
        ...
        else //Se a apresentacao for poster, imprima este PDF
        {
            $tituloPoster  = iconv("UTF-8","ISO-8859-1",$campos[titulo]);
            $tituloPoster = iconv("ISO-8859-1","UTF-8",$tituloPoster);
            ...
            $dizeres = "  
        Certificamos que o trabalho intitulado <b>\"$campos[titulo]\"</b>, de autoria de $nomeAutor1 $nomeOrientador $nomeAutor2 $nomeAutor3 $nomeAutor4 $nomeAutor5 $nomeAutor6 $nomeAutor7 
        foi apresentado na forma de p&ocirc;ster por $apresentador[nome] no XV Simp&oacute;sio de Ci&ecirc;ncia,
        Inova&ccedil;&atilde;o e Tecnologia do Campus Rio Pomba, realizado entre os dias 25 e 26 de outubro de 2023.
        ";
