...
(function () {
    ...
    (function () {
        ...
        j.add('htmldataprocessor', {
            requires: ['htmlwriter'], init: function (T) {
    ...
    (function () {
        var m = {
            modes: {wysiwyg: 1, source: 1}, canUndo: false, readOnly: 1, exec: function (o) {
    ...
    (function () {
        ...
        var s = {
            modes: {wysiwyg: 1, source: 1}, readOnly: c || b.webkit, exec: function (y) {
                switch (y.mode) {
                    case 'wysiwyg':
                ...
                var y = c ? (function () {
                    ...
                    var A = function (B, C) {
                        ...
                        if (L == -1 || L == F.length - 1 && M < 0) {
                            ...
                            if (!N) {
                                G = F[F.length - 1];
                                if (G.nodeType == 1)return {container: D, offset: F.length}; else return {
                                    container: G,
