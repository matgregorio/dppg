...
if (in_array("1", $_SESSION[codigo_grupo])) {
    ...
    <html>
    <head>
        <title> Alterar Assinatura 1</title>
        <link rel="stylesheet" type="text/css" href="css/style.css">
        <script type="text/JavaScript" src="js/valida_form_assinatura.js"></script>
    ...
    if ($_SESSION[logado_simposio_2021]) {
        ...
        $sql = "select assinatura, cargo from conteudo where codigo_conteudo = '8'";
        ...
        echo "<div id='conteudo3'>
				<br>
				<center><b>Alterar Conteudo Assinatura 1</b><br><br></center>
				<center>
				<form name='form_assinatura' method='POST' action='update_assinatura.php'  onsubmit='javascript: return checkcontatos()' enctype='multipart/form-data'>
