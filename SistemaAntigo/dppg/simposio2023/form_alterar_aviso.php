...
if (in_array("1", $_SESSION[codigo_grupo])) {
    ...
    <html>
    <head>
        <title> Alterar Aviso Atendimento</title>
    ...
    $sql = "select informacoes from conteudo where codigo_conteudo = '5'";
    ...
    if ($_SESSION[logado_simposio_2021]) {
        ...
        echo "<div id='conteudo3'>
			<br>
			<center><b>Alterar Aviso Atendimento<b><br><br></center>
			
			<center>
			<form name='form_altera_aviso' method='POST' onsubmit='javascript: return checkcontatos()' action='update_aviso.php'>
