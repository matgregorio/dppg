...
if (in_array("1", $_SESSION[codigo_grupo])) {
    ...
    <html>
    <head>
        <title> Alterar Data Inscrição</title>
    ...
    if ($_SESSION[logado_simposio_2021]) {
        ...
        echo '<div id="conteudo3">
				<br>
				<center><b>Alterar Data Inscrição Eventos</b><br><br></center>';
        ...
        if ($_POST[confirma] == "S") {
			...
			data_modificacao = '$data_modificacao', hora_modificacao = '$hora_modificacao' where codigo_formulario = '6'";
            $resultado_data = mysql_query($sql_data);

            echo '<center><font color="#006400"><b>Data Inscrição em Eventos Alterada com sucesso !!!</b></font><br><br></center>
					<meta http-equiv="refresh" content="3; URL=form_alterar_data_inscricao.php" />';
        }

        $sql = "select data_inicio, data_fim from formularios where codigo_formulario = '6'";
        ...
        echo "<center>
				<form name='form_altera_data' method='POST' onsubmit='return  checkcontatos();' action='form_alterar_data_inscricao.php'   enctype='multipart/form-data'>
