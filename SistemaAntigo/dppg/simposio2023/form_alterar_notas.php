...
//        echo $sql."<br>";
        ...
        echo "</div>";
        echo '<meta http-equiv="refresh" content="3; URL=form_alterar_notas.php" />';
    } else {
        ?>
        <body>
        <center>
            <div id='conteudo3'>
                <div id="scroll">
                    ...
                    <form name="form_adcionar_notas" method="post" action="form_alterar_notas.php">
                        ...
                        <td><center><b><font color="#FFFFFF">&nbsp;Nota2 &nbsp;</font></b></center></td>
                                ...
                                while ($campo_participante = mysql_fetch_array($query_participante)) {
                                    ...
                                    echo "<td align='left'><input type='text' maxlength='3' id='nota1' name='nota1[]' value='$campo_participante[nota1]' size='5' onkeypress='return SomenteNumero(event)'></td>";
                                    echo "<td align='left'><input type='text' maxlength='3' id='nota2' name='nota2[]' value='$campo_participante[nota2]' size='5' onkeypress='return SomenteNumero(event)'></td>";
                                ...
                                echo '<tr><td colspan="4" style="text-align: center;"><input type="submit" name="salva" value="Alterar Notas"</td></tr>';
                            } else {
