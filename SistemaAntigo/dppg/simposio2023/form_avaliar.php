  ...
  <script type="text/javascript">
    ...
    function media()
    {
          var nota1, nota2, nota3, nota4, nota5, nota6;
            ...
            //Nota 1
            if (document.getElementById("item1").value < 0 || document.getElementById("item1").value > 10)
            {
            ...
            //Nota 6
            if (document.getElementById("item6").value < 0 || document.getElementById("item6").value > 20)
            {
                alert("A nota deve estar entre 0 e 20!");
            ...
            <td valign='top' width="50%">
              <form name="form_avaliar" action="form_avaliar.php" method="post">
                <table border="0"  width="100%" onmousemove="media()">
                  ...
                  <tr>
                      <td width="120px"> <font color="green"><strong>Até 10 pontos:</strong></font></td>
                    <td align="left"><input type="text" style="border-color: green" maxlength="2" id="item1" name="item1" size="5" onkeypress='return SomenteNumero(event)' onkeyup="media()" onchange="media()"></td>
                  </tr>
                  <tr><td colspan="2"><hr></td></tr>
                  <tr>
                  ...
                  <tr>
                      <td width="120px"> <font color="green"><strong>Até 10 pontos:</strong></font></td>
                    <td align="left"><input type="text" style="border-color: green" maxlength="2" id="item2" name="item2" size="5" onkeypress='return SomenteNumero(event)' onkeyup="media()" onchange="media()"></td>
                  </tr>
                  <tr><td colspan="2"><hr></td></tr>
                  <tr>
                    <td colspan="2"><b>3-</b> Qualidade da redação científica (Ortografia, gramática, clareza, objetividade e estrutura formal)</td>
                  </tr>
                  <tr>
                      <td width="120px"> <font color="green"><strong>Até 20 pontos:</strong></font></td>
                    <td align="left"><input type="text" style="border-color: green" maxlength="2" id="item3" name="item3" size="5" onkeypress='return SomenteNumero(event)' onkeyup="media()" onchange="media()"></td>
                  </tr>
                  <tr><td colspan="2"><hr></td></tr>
                  <tr>
                  ...
                  <tr>
                      <td width="120px"> <font color="green"><strong>Até 20 pontos:</strong></font></td>
                    <td align="left"><input type="text" style="border-color: green" maxlength="2" id="item4" name="item4" size="5" onkeypress='return SomenteNumero(event)' onkeyup="media()" onchange="media()"></td>
                  </tr>
                  <tr><td colspan="2"><hr></td></tr>
                  <tr>
                    <td colspan="2"><b>5-</b> Metodologia (Permite a obtenção dos objetivos propostos?)</td>
                  </tr>
                  <tr>
                      <td width="120px"> <font color="green"><strong>Até 20 pontos:</strong></font></td>
                    <td align="left"><input type="text" style="border-color: green" maxlength="2" id="item5" name="item5" size="5" onkeypress='return SomenteNumero(event)' onkeyup="media()" onchange="media()"></td>
                  </tr>
                  <tr><td colspan="2"><hr></td></tr>
                  <tr>
                    <td colspan="2"><b>6-</b>  Resultados e Conclusões (Os objetivos foram alcançados? Os resultados apresentados e as conclusões são claros? ) </td>
                  </tr>
                  <tr>
                      <td width="120px"> <font color="green"><strong>Até 20 pontos:</strong></font></td>
                    <td align="left"><input type="text" style="border-color: green" maxlength="2" id="item6" name="item6" size="5" onkeypress='return SomenteNumero(event)' onkeyup="media()" onchange="media()"></td>
                  </tr>
                  <tr><td colspan="2"><hr></td></tr>
                  <tr>
                    <td colspan="2">
                        <b> <font color="green"><strong>Total de pontos (até 100 pontos)</strong></font></b>
                      <input type="text" style="border-color: green" maxlength="2" id="total" name="total" size="5" readonly="true" value="0">
                    </td>
                  </tr>
                  <tr><td colspan="2"><hr></td></tr>
                  <tr>
