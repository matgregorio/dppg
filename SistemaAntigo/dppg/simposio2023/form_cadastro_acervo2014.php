...
if (in_array("1", $_SESSION[codigo_grupo])) {
  ...
  $sql = "SELECT trabalhos.*, participantes.nome, participantes.cpf, sub_area.nome_sa FROM sub_area, trabalhos, participantes WHERE participantes.cpf=trabalhos.cpf AND trabalhos.codigo_sa=sub_area.codigo_sa AND trabalhos.aprovado='1' AND trabalhos.aprovado_ext='1' AND trabalhos.acervo='0' ORDER BY sub_area.nome_sa, trabalhos.titulo";
    ...
    <div  id="individual">
      <table border="0" width="90%" class="esquerda">
        ...
        <tr>
          ...
          <td>
            <input type="radio" onclick="script : mostrarIC(this.value)" onchange="script : mostrarIC(this.value)" name="modalidade" value="S">Sim
            <input type="radio" onclick="script : mostrarIC(this.value)" onchange="script : mostrarIC(this.value)" name="modalidade" value="N" checked="true">Não
          </td>
        </tr>
        <tr><br></tr>
        ...
        <tr>
          <td>Orientador:</td>
          <td><select id="orientador" name="orientador" onload="list_orientador(this.value)"></select><font color="#FF0000"> *</font></td>
        </tr>
        <tr>
          <td>Palavra-Chave</td>
      ...
      <table border="0" width="80%" class="center">
        ...
        <tr>
          <td colspan="2"><br>
            <font size="3" color="#FF0000">* </font>Campo de preenchimento obrigatório</td>
        </tr>
      </table>
