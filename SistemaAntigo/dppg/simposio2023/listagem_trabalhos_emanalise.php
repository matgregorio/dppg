...
//faltou o atributo local e título tabela sub eventos
    ...
    if (mysql_num_rows($resultado) > 0) {
        ...
        echo "<center><i>Não há trabalhos em análise.</i></center><br><br>";
    }
}
mysql_close($conexao);
?>