...
if ($_FILES[arquivo][name] != "") {
    ...
    if (eregi("^image\/(pjpeg|jpeg|png|gif|bmp)", $_FILES[arquivo]["type"])) {
        ...
        if (move_uploaded_file($_FILES[arquivo][tmp_name], $dir . $arquivo)) {
            ...
            $sql1 = "update conteudo set assinatura = '$nome', cargo='$cargo', imagem_assinatura='$arquivo', assinatura_certificado='1'  where codigo_conteudo='9'";
            $resultado1 = mysql_query($sql1);

            echo '<center><font color="#006400"><b>Imagem Assinatura, Nome e Cargo alterados com sucesso!!!</b></font></center>';
            echo '<meta http-equiv="refresh" content="3; URL=form_alterar_assinatura2.php">';
        }
        //}
        ///	else
        //		{
...
/*else
    {
                $sql1 = "update conteudo set assinatura='$_POST[nome]', cargo='$_POST[cargo]', assinatura_certificado='1'  where codigo_conteudo='9'";
                $resultado1 = mysql_query($sql1);
